...
1. GUARD: run deploy-guard step 0-1 — identify + announce the deployment being read. Read production insights/logs only when that target is explicitly authorized; never enable mutating prod access for an advisory pass.
